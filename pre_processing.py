...
#storin each type of images in a list for easy working
brain_mask=[]
brain=[]
raw=[]
...
Because of magnetic field variations intensity of images changes it order to retify use use Bias Feild Correction
