...
##taking all images in a list for passing into model for training
...
##Creating batchs of images for training
...
##Defining images parameters for model training
im_height=96
im_width=128
img_depth=160
epochs=60
...
channels=1
input_img = Input((im_height, im_width,img_depth,channels), name='img') ##setting parameters for images 
...
##Saving the model into json for future referencing of model architecture
...
model_weights_path = r'C:\Users\Administrator\Downloads\nfbs\model_weights_unet.h5'
model.save_weightsmodel_weights_path 
